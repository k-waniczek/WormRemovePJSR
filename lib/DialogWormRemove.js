function WormRemoveDialog() {
    ...
    with(this.generateStarMask) {
        text = "Generate star mask";
        checked = xtParameters.generateStarMask;
        toolTip = "<p>Generate star mask option in StarXterminator";
        onCheck = function (value) { xtParameters.generateStarMask = value };
    }
